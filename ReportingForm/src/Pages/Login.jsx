                ...
                {describe && (
                  <>
                    <div className="grid grid-cols-1  sm:grid-cols-4 lg:grid-cols-8 gap-4">
                      {LoginData.map((items) => (
                        <div className="border w-28 h-28 flex py-2 items-center justify-center shadow-sm rounded-md hover:bg-green-200 hover:border-2 hover:border-green-600 ">
                  ...
                  <>
                    <div className="flex items-center gap-x-6">
                      <div className="w-32 rounded-md  bg-slate-100 h-32 border hover:bg-green-200 hover:border-2 hover:border-green-600 flex flex-col items-center justify-center">
                        <img src={Mainswitch} className=" object-contain  h-12 w-12 " />
